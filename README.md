...
<b>FLUENCE FUHD PATCH V8.0 “OEFF”</b>
  * CHANGED FOCUS ON XIAOMI SD GSI DEVICES
  * REMOVED INCOMPATIBLE CONTENT
  * REMOVED AROMA INSTALLER
  * ADDED VOLUME KEY SELECTOR TOOL
  * ADDED AOSP APP REMOVEMENT (NEED TO FLASH GAPPS)
  * ADDED AUDIO LIBS FROM SONY AND LG PIE
  * ADDED AUDIO CONFIGS FROM SONY AND LG PIE
  * ADDED NEW SERVICE CONFIGS FROM SONY AND LG PIE
